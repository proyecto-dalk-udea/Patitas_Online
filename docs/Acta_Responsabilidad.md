...
Para el desarrollo del proyecto Gestor de PQRS, se acuerda la siguiente distribución de responsabilidades:
...
El equipo se compromete a cumplir con los avances establecidos para el proyecto:
* Entrega 1 – Semana 8: documentación inicial y elementos solicitados para la primera entrega.
* Entrega 2 – Semana 15: programa completo, archivos, documentación y demás elementos requeridos.
* Semana 16: preparación y presentación de la sustentación final.
Los avances se revisarán previamente para realizar las correcciones necesarias antes de cada entrega.

## 3. Seguimiento
El equipo realizará reuniones periódicas para revisar el avance del proyecto y verificar que las actividades se estén cumpliendo.
Si es necesario modificar alguna responsabilidad o fecha, el cambio será hablado y acordado entre todos los integrantes.

## 4. Compromiso del equipo
Todos los integrantes nos comprometemos a:
* Cumplir con las responsabilidades asignadas.
* Participar activamente en el desarrollo del proyecto.
* Mantener una comunicación constante.
* Apoyar a los demás integrantes cuando sea necesario.
* Revisar el trabajo antes de las entregas.
* Conocer y comprender el funcionamiento general del proyecto.
